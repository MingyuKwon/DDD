...
void ADDDPlayerController::BeginPlay()
{
	...
	{
		HUDWidget = CreateWidget<UDDDGameplayHUD>(this, HUDWidgetClass);
		if (HUDWidget)
		{
...
void ADDDPlayerController::SetupInputComponent()
{
...
bool ADDDPlayerController::ShouldUseTouchControls() const
{
